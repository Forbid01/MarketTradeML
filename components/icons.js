// Мэргэжлийн line icon-ууд (Lucide маягийн). Нэмэлт сангүй, stroke=currentColor.
// Server болон Client Component хоёуланд ашиглаж болно (hook ашиглаагүй).

function Svg({ size = 20, className = "", strokeWidth = 2, fill = "none", children, ...props }) {
  return (
    <svg
...
export function Logo(p) {
  return (
    <Svg {...p}>
      <path d="M12 2 4 5v6c0 5 3.5 7.5 8 9 4.5-1.5 8-4 8-9V5z" />
      <path d="M12 7.5 9 12l3 4.5 3-4.5z" />
    </Svg>
  );
}
...
export function ClipboardCheck(p) {
  return (
    <Svg {...p}>
...
export function Heart({ filled, ...p }) {
  return (
    <Svg fill={filled ? "currentColor" : "none"} {...p}>
...
// Сошиал линкүүд (footer) — lucide-ийн facebook/instagram path-ууд
