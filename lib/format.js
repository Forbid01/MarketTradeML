...
export function formatDateTime(value, locale = "mn") {
  ...
  try {
    return new Intl.DateTimeFormat(intl(locale), {
      dateStyle: "medium",
      timeStyle: "short",
      // Тогтмол цагийн бүс: сервер (UTC) ба клиент (хэрэглэгчийн TZ) ИЖИЛ текст гаргаж
      // hydration mismatch-аас сэргийлнэ; зах зээл нь Монгол тул УБ-ын цагаар харуулна.
